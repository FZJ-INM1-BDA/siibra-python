...
ids = [
    ...
    "cf0::BigBrainIntensityProfile::p:minds/core/parcellationatlas/v1.0.0/94c1125b-b87e-45e4-901c-00daee7f2579-290::r:Area hOc1 (V1, 17, CalcS) left::26d25994-634c-40af-b88f-2a36e8e1d508::9c6a6cd32ed02afb2e7a730a9711180a",  # CompoundFeature of 1697 BigBrainIntensityProfile features grouped by (Modified silver staining modality) anchored at Area hOc1 (V1, 17, CalcS) left with Set of 1697 points in the Bounding box from (-63.35,-59.39,-33.88) mm to (3.68,76.02,54.49)mm in BigBrain microscopic template (histology) space
    "lq0::BigBrainIntensityProfile::p:minds/core/parcellationatlas/v1.0.0/94c1125b-b87e-45e4-901c-00daee7f2579-290::r:Area hOc1 (V1, 17, CalcS) left::26d25994-634c-40af-b88f-2a36e8e1d508--b81a4aba231ba46f025072a155300676",  # BigBrainIntensityProfile (Modified silver staining) anchored at Area hOc1 (V1, 17, CalcS) left with Point in BigBrain microscopic template (histology) [-23.5669,62.4246,22.8711]
    ...
    "3f179784-194d-4795-9d8d-301b524ca00a--63aa6fdf5d7f530f6e2e9e67c23ef538--9c08356ec0454773885ded630e49b5d3",  # FunctionalConnectivity (FunctionalConnectivity) anchored at minds/core/parcellationatlas/v1.0.0/94c1125b-b87e-45e4-901c-00daee7f2579-290 with cohort 1000BRAINS - 0108_1, Resting state (RestEmpCorrFC) paradigm
