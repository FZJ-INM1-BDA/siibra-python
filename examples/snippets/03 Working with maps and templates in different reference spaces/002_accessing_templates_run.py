...
Different from semantic objects like atlases, spaces, parcellations, and
regions, a reference template is a spatial object - more precisely an image
volume or surface mesh. It is linked to a particular brain reference space,
therefore we access templates by specifying the space. As all image and mesh
objects in `siibra`, instantiation of a reference space is lazy: The actual
image or meshdata will only be loaded after explicitely calling a "fetch"
method.
"""
