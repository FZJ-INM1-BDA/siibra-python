...
==========================
The following diagrams automatically generated by `pyreverse<https://pylint.readthedocs.io/en/latest/pyreverse.html>` (.github/docs.yml).
...
Classes
--------
- Diamond arrow: shows the relation between two classes via variable name
- Triangular arrow: ancestor
- Dahsed triangular arrow: interface
