...
class HasTerminologyVersion(BaseModel):
    ...
    hasEntityVersion: List = Field(..., min_items=1, title='hasEntityVersion')
    isAlternativeVersionOf: Optional[List] = Field(
        None,
    ...
    isNewVersionOf: Optional[Any] = Field(
        None,
...
class Model(BaseModel):
    ...
    hasTerminologyVersion: HasTerminologyVersion = Field(
