...
#   filename:  https://raw.githubusercontent.com/HumanBrainProject/openMINDS/dbb4c54/v3/SANDS/v3/atlas/atlasAnnotation.schema.json
...
class Model(BaseModel):
    ...
    visualizedIn: Optional[Dict[str, Any]] = Field(
        None,
