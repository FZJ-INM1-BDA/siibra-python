...
#   filename:  https://raw.githubusercontent.com/HumanBrainProject/openMINDS/dbb4c54/v3/core/v4/products/metaDataModelVersion.schema.json
...
class Model(BaseModel):
    ...
    serializationFormat: Optional[List[Any]] = Field(
        None,
    ...
    specificationFormat: Optional[List[Any]] = Field(
        None,
