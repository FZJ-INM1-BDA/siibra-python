...
#   timestamp: 2021-11-25T12:27:19+00:00
...
class Model(BaseModel):
    ...
    applicationCategory: List[Any] = Field(
        ...,
    ...
    fullDocumentation: Dict[str, Any] = Field(
        ...,
    ...
    inputFormat: Optional[List[Any]] = Field(
        None,
    ...
    operatingSystem: List[Any] = Field(
        ...,
    ...
    otherContribution: Optional[OtherContribution] = Field(
        None,
    ...
    outputFormat: Optional[List[Any]] = Field(
        None,
    ...
    programmingLanguage: List[Any] = Field(
        ...,
    ...
    relatedPublication: Optional[List[Any]] = Field(
        None,
    ...
    supportChannel: Optional[List[str]] = Field(
        None,
