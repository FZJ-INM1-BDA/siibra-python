...
#   filename:  https://raw.githubusercontent.com/HumanBrainProject/openMINDS/dbb4c54/v3/core/v4/products/modelVersion.schema.json
...
class Model(BaseModel):
    ...
    outputData: Optional[List[Any]] = Field(
        None,
