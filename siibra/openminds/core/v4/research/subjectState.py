...
#   filename:  https://raw.githubusercontent.com/HumanBrainProject/openMINDS/dbb4c54/v3/core/v4/research/subjectState.schema.json
...
class Model(BaseModel):
    ...
    ageCategory: Dict[str, Any] = Field(
        ...,
