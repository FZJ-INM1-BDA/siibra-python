...
SIIBRA_USE_VOLUME_SRC_MAPPING_FILE = os.getenv("SIIBRA_USE_VOLUME_SRC_MAPPING_FILE")
SIIBRA_USE_VOLUME_SRC_MAPPING_PREFIX = os.getenv("SIIBRA_USE_VOLUME_SRC_MAPPING_PREFIX")
