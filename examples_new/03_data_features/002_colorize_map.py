...
import siibra
# We start by selecting an Julich-Brain parcellation.
julich_brain = siibra.get_parcellation('julich 3')
...
# to Julich-Brain.
fingerprints = siibra.find_features(julich_brain, siibra.modality_types.NEUROTRANSMITTER_RECEPTOR_DENSITY_FINGERPRINT)
feature, *_ = fingerprints[0]
feature.data
